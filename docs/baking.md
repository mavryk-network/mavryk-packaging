...
1) Alternatively, you can generate a fresh baker key and fill it using faucet from https://testnets.mavryk.network.
...
Then visit https://testnets.mavryk.network and fill the address with at least 6000 XTZ on the desired testnet.
