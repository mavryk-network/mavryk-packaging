...
# copying virtual opam file which depends on everything mavkit need
mkdir -p opam-repository/packages/mavkit-deps/mavkit-deps.dev
cp mavryk/opam/virtual/mavkit-deps.opam.locked opam-repository/packages/mavkit-deps/mavkit-deps.dev/opam
